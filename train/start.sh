...
python3 prompt_eval.py \
    ...
    --test_file /apdcephfs_cq3/share_2973545/curvasong/dataset/belle/belleMath-dev1K.json \
    --predictions_file /apdcephfs_cq3/share_2973545/curvasong/test/predictions.json